...
export const waveCardPreview = (props: any) => {
...
export const waveCardDependencies: string[] = ["clsx", "tailwind-merge"];

export const waveCardUsageCode = `<WaveCard
  ...
  iconSize={48}
/>`
export const waveCardProps: PropConfig[] = [
        { isEditable: true, 
            name: 'title',
            type: 'string' ,
...
export const waveCardRegistry: ComponentEntry = {
        ...waveCardMeta,
        preview: waveCardPreview,
        props: waveCardProps,
        dependencies: waveCardDependencies,
        usageCode: waveCardUsageCode,
    };
