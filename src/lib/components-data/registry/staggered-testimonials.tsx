...
export const staggeredTestimonialsUsageCode = `const testimonials = [
{
...
export const staggeredTestimonialsPreview = ({ containerHeight }: any) => {
    return (
...
export const staggeredTestimonialsProps: PropConfig[] = [
                { isEditable: true,  name: 'containerHeight', type: 'number',  default: 600, min: 400, max: 1000, step: 10 }
            ];
export const staggeredTestimonialsRegistry: ComponentEntry = {
        ...staggeredTestimonialsMeta,
        preview: staggeredTestimonialsPreview,
        props: staggeredTestimonialsProps,
        dependencies: ["clsx", "tailwind-merge"],
        usageCode: staggeredTestimonialsUsageCode,
    };
