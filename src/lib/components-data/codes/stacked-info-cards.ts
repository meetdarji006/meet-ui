...
export function StackedInfoCards({ items, className, cardColor = "#7c3aed", stackColor = "#a78bfa", textColor = "#ffffff", navColor = "#ffffff", navActiveColor = "#7c3aed", borderRadius = 20, showDashedLine = true, }) {
    ...
    return (<div className={cn("relative w-full", className)}>
            <div className="relative w-full" style={{ minHeight: 480, maxWidth: 520, margin: "0 auto" }}>
                {/* Left stack — previous cards */}
            ...
            mass: 0.9,
                        ...
                        <div className="p-8 md:p-10 flex flex-col h-full" style={{ minHeight: 480 }}>
                            <div className="mb-2">
                ...
                opacity: 0.4,
                            ...
                            <h3 className="text-2xl md:text-3xl font-light leading-snug mb-4" style={{ color: textColor, fontFamily: "serif" }}>
                                {items[currentIndex].title}
                            </h3>

                            <p className="text-base md:text-lg leading-relaxed opacity-90" style={{ color: textColor }}>
                                {items[currentIndex].description}
                            </p>
                        </div>
                    </motion.div>
                ...
                {/* Navigation arrows */}
                <div className="absolute bottom-6 left-8 z-20 flex items-center gap-2">
                    <button onClick={() => paginate(-1)} className="w-11 h-11 rounded-full flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95" style={{
            backgroundColor: "#fff",
            color: cardColor,
        }} aria-label="Previous">
                        <ArrowLeft className="w-5 h-5"/>
