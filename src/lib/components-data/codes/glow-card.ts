// Auto-generated from glow-card.tsx
// Run: npm run generate-codes

export const glowCardCodeTS = `"use client"
...
export const glowCardCodeJS = `"use client";
import React from "react";
import { cn } from "@/lib/utils";
export function GlowCard({ value = "750k", label = "Views", accentColor = "#a78bfa", bgColor = "#09090b", showRay = true, showGrid = true, showDot = true, className, }) {
    const uid = React.useId().replace(/:/g, "");
    return (<>
            <style>{\`
                .gc-\${uid} {
